...
| `fix_title_slide.py` | Script that cleans up the title-slide text layout |
| `ppt_images/` | Real Patna photos + Pune case-study photo embedded in the deck |

## Slide Outline

1. Title (DySP credit only + Patna Traffic Police cover photo)
2. Session Agenda
...
python fix_title_slide.py        # clean up title slide text layout
```
